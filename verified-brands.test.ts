...
describe("verified brand directory", () => {
  ...
  it("adds accessible premium hover treatments to selected card surfaces", () => {
    ...
    expect(verified).toContain("/assets/images/jibi-med_531ea85a.png");
    expect(verified).toContain("/assets/images/shandong-nkt_d381b4d2.webp");
    expect(verified).toContain("/assets/images/fuji-electric_77d5fbaa.webp");
    expect(verified).toContain("/assets/images/binder_b76d36a0.png");
    expect(verified).toContain("/assets/images/pruftechnik_c296e7b1.png");
    expect(verified).toContain("/assets/images/ygyb_681d5e6d.png");
    expect(verified).toContain("/assets/images/gtj_81cc4aba.png");
    expect(verified).toContain("/assets/images/scitek_665b073a.png");
    expect(verified).toContain("/assets/images/heal-force_f1a0570c.png");
