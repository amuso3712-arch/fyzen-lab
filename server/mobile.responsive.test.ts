...
describe("mobile responsive guardrails", () => {
  ...
  it("keeps verified brand logos visible in narrow preview cards", () => {
    ...
    expect(verifiedBrandsSource).toContain("/manus-storage/gtj_81cc4aba.png");
    expect(verifiedBrandsSource).toContain("/manus-storage/ygyb_681d5e6d.png");
    expect(verifiedBrandsSource).toContain("/manus-storage/scitek_665b073a.png");
    expect(verifiedBrandsSource).toContain("/manus-storage/heal-force_f1a0570c.png");
    expect(verifiedBrandsSource).toContain("/manus-storage/pruftechnik_c296e7b1.png");
  });
